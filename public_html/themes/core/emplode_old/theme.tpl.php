...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    ...
    <head>
    	...
    	<meta name="description" content="<?php echo CORE_SITE_DESCRIPTION; ?>"/>
    	<meta name="keywords" content="" />
    	<meta name="author" content="<?php echo $site_author; ?>" />
    	<link rel="stylesheet" type="text/css" href="<?php echo $site_styleSheet; ?>" media="screen" />
    	<title><?php echo CORE_SITE_TITLE; ?></title>
        	...
        	<div class="center_wrapper">
        		...
        		<div id="site_title">
        			<h1>
                        ...
                        <a href="<?php echo BASEDIR; ?>"><?php echo CORE_SITE_TITLE; ?></a>
                    </h1>
        			<p><?php echo CORE_SITE_TAGLINE; ?></p>
        		</div>
