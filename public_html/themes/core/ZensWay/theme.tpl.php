...
<head>
	...
	<link rel="stylesheet" media="screen" href="/001/001.css?v=8may2013">
			...
			<div class="design-selection" id="design-selection">
				...
				<nav role="navigation">
					...
					<li>
						...
						<a href="?cssfile=/208/208.css" class="design-name">Sakura</a> by						<a href="#" class="designer-name">Tatsuya Uchida</a>
					</li>					<li>
						<a href="?cssfile=/207/207.css" class="design-name">Kyoto Forest</a> by						<a href="http://rpmdesignfactory.com/" class="designer-name">John Politowski</a>
					</li>					<li>
						<a href="?cssfile=/206/206.css" class="design-name">A Walk in the Garden</a> by						<a href="http://users.skynet.be/bk316398/temp.html" class="designer-name">Simon Van Hauwermeiren</a>
					</li>					</ul>
				</nav>
			</div>
