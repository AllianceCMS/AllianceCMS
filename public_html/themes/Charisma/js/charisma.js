$(document).ready(function(){
	...
	{
		var themePath = window.location.protocol + "//" + window.location.host + "/themes/Charisma";
		
		$('#bs-css').attr('href', themePath + '/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	var elf = $('.file-manager').elfinder({
		url : themePath + 'misc/elfinder-connector/connector.php'  // connector URL (REQUIRED)
	}).elfinder('instance');
	...
	$('#file_upload').uploadify({
		'swf'      : themePath + 'misc/uploadify.swf',
		'uploader' : themePath + 'misc/uploadify.php'
