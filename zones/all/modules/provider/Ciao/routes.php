 ...
 * @code
 * // One entry per route
 * $moduleRoutes[$moduleName][$pageName] = [ // $moduleName can be a human spoken name and must be unique, $pageName can be a human spoken name and is used as a descriptor and must be unique
 ...
 *     'perms' => ['view_ciao'], // Optional. An array of route permissions. This route will be denied to users that do not have this permission. Might be replaced by ModulePerms.php. Not implemented.
