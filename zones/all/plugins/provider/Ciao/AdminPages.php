<?php
/**
 * Ciao Plugin namespace
 *
 * Use the same name as the plugin folder to comply with PSR-0 and so internal autoloader will load this controller properly
 *
 */
...
/**
 * Use statements needed for plugin dev
 *
 ...
 *     The AbstractAdmin Class extends the AbstractPlugin Class, and also provides functionality and helper methods used specifically for admin pages.
 *
...
class AdminPages extends AbstractAdmin
{
    ...
    {
        // The following uses the AbstractAdmin helper method 'compileTabs' to easily create consistent dynamic tabs in your plugin page output
