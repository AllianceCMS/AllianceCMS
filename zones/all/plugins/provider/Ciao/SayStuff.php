 ...
 *
 * Eases access to the AbstractPlugin and Template Classes
 */
 ...
 * Class Definition
 *
 * All 'front' controllers need to extend the AbstractPlugin abstract Class.
 *     The AbstractPlugin Class provides the __contruct method and other helper methods used for plugin development.
 *
