				...
				<ul class="recent-posts">
					<li>
						<div class="user-thumb">
							<img width="40" height="40" alt="User" src="<?php echo $theme_folder; ?>/themes/images/avatar2.png">
						</div>
					...
					<li>
						<div class="user-thumb">
							<img width="40" height="40" alt="User" src="<?php echo $theme_folder; ?>/themes/images/avatar3.png">
						</div>
						<div class="article-post">
					...
					<li>
						<div class="user-thumb">
							<img width="40" height="40" alt="User" src="<?php echo $theme_folder; ?>/themes/images/avatar1.png">
						</div>
						<div class="article-post">
